...
class PlacesAPIActivity : AppCompatActivity(), OnMapReadyCallback, PlacesListener {
    ...
    var ex_marker = arrayListOf<Marker>()
...
//            //중복 마커 제거
            ...
            hashSet.addAll(ex_marker)
            ex_marker.clear()
            ex_marker.addAll(hashSet)
        }
    }
